      ...
      <nav className="relative z-10 p-6">
        <div className="flex justify-between items-center max-w-6xl mx-auto">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-white font-bold text-xl">Note Zipper</span>
          </div>
      ...
      <div className="relative z-10 flex items-center justify-center px-6 pt-12">
        <div className="max-w-4xl text-center">
          ...
          <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm text-gray-200">Trusted by 10k+ users worldwide</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 group">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">Bank-Level Security</h3>
              <p className="text-gray-400 text-sm">End-to-end encryption ensures your notes remain private and secure</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 group">
              ...
              <p className="text-gray-400 text-sm">Instant sync across all devices with real-time collaboration</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 group">
              ...
              <h3 className="text-white font-semibold text-lg mb-2">Team Ready</h3>
              <p className="text-gray-400 text-sm">Share and collaborate with your team seamlessly</p>
            </div>
          </div>
        </div>
      </div>
